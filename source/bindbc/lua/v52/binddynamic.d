...
extern(C) @nogc nothrow {
    // lauxlib.h
    alias pluaL_checkversion_ = void function(lua_State*,lua_Number);
    ...
    alias pluaL_checkunsigned = lua_Unsigned function(lua_State*,int);
    alias pluaL_optunsigned = lua_Unsigned function(lua_State*,int,lua_Unsigned);
    ...
    alias plua_tounsignedx = lua_Unsigned function(lua_State*,int,int*);
    ...
    alias plua_pushunsigned = void function(lua_State*,lua_Unsigned);
    ...
    alias plua_getglobal = void function(lua_State*,const(char)*);
    ...
    alias plua_rawgetp = void function(lua_State*,int,const(void)*);
    ...
    alias plua_getuservalue = void function(lua_State*,int);
    ...
    alias plua_callk = void function(lua_State*,int,int,int,lua_CFunction);
    alias plua_getctx = int function(lua_State*,int*);
    alias plua_pcallk = int function(lua_State*,int,int,int,int,lua_CFunction);
    alias plua_load = int function(lua_State*,lua_Reader,void*,const(char)*);
    alias plua_dump = int function(lua_State*,lua_Writer,void*);
    alias plua_yieldk = int function(lua_State*,int,int,lua_CFunction);
    ...
    alias plua_upvalueid = void* function(lua_State*,int,int);
    alias plua_upvaluejoin = void function(lua_State*,int,int,int,int);
